...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_cloudwatch_observability_irsa"></a> [aws\_cloudwatch\_observability\_irsa](#module\_aws\_cloudwatch\_observability\_irsa) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks | 5.48.0 |
| <a name="module_cluster_autoscaler_irsa"></a> [cluster\_autoscaler\_irsa](#module\_cluster\_autoscaler\_irsa) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks | 5.48.0 |
| <a name="module_ebs_csi_irsa"></a> [ebs\_csi\_irsa](#module\_ebs\_csi\_irsa) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks | 5.48.0 |
| <a name="module_eks"></a> [eks](#module\_eks) | terraform-aws-modules/eks/aws | 20.8.5 |
| <a name="module_eks_node_iam_role"></a> [eks\_node\_iam\_role](#module\_eks\_node\_iam\_role) | terraform-aws-modules/iam/aws//modules/iam-assumable-role | 5.48.0 |
...
| <a name="module_external_dns_irsa"></a> [external\_dns\_irsa](#module\_external\_dns\_irsa) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks | 5.48.0 |
| <a name="module_karpenter"></a> [karpenter](#module\_karpenter) | terraform-aws-modules/eks/aws//modules/karpenter | 20.8.5 |
| <a name="module_load_balancer_controller_irsa"></a> [load\_balancer\_controller\_irsa](#module\_load\_balancer\_controller\_irsa) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks | 5.48.0 |
| <a name="module_rds"></a> [rds](#module\_rds) | terraform-aws-modules/rds-aurora/aws | 9.10.0 |
| <a name="module_rds-analytics"></a> [rds-analytics](#module\_rds-analytics) | terraform-aws-modules/rds-aurora/aws | 9.10.0 |
...
| [aws_db_parameter_group.analytics](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/db_parameter_group) | resource |
...
| [aws_eks_addon.amzn_cloudwatch_observability](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_addon) | resource |
...
| [aws_rds_cluster_parameter_group.analytics](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/rds_cluster_parameter_group) | resource |
...
| <a name="input_aws_cloudwatch_observability_version"></a> [aws\_cloudwatch\_observability\_version](#input\_aws\_cloudwatch\_observability\_version) | The version of the AWS Cloudwatch Observability Addon. Specify a version to enable the addon, or leave blank to disable the addon. | `string` | n/a | yes |
...
| <a name="input_ec_redis_auth_token"></a> [ec\_redis\_auth\_token](#input\_ec\_redis\_auth\_token) | The auth token for REDIS. Requires ec\_transit\_encryption\_enabled. | `string` | `""` | no |
...
| <a name="input_eks_node_groups"></a> [eks\_node\_groups](#input\_eks\_node\_groups) | n/a | <pre>list(object({<br/>    name            = string<br/>    min_size        = string<br/>    desired_size    = string<br/>    max_size        = string<br/>    volume_type     = optional(string, "gp3")<br/>    disk_size       = optional(number, 225)<br/>    disk_iops       = optional(number, 3000)<br/>    disk_throughput = optional(number, 125)<br/>    device_name     = optional(string, "/dev/xvda")<br/>    instance_types  = list(string)<br/>    capacity_type   = optional(string, "ON_DEMAND")<br/>    labels          = optional(map(string), {})<br/>    taints          = optional(map(object({ key = string, value = string, effect = string })), {})<br/>  }))</pre> | <pre>[<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 3,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "max_size": 30,<br/>    "min_size": 3,<br/>    "name": "ast-app"<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "sast-engine": "true"<br/>    },<br/>    "max_size": 50,<br/>    "min_size": 0,<br/>    "name": "sast-engine",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "sast-engine",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "sast-engine-large": "true"<br/>    },<br/>    "max_size": 50,<br/>    "min_size": 0,<br/>    "name": "sast-engine-large",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "sast-engine-large",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "r6iz.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "sast-engine-extra-large": "true"<br/>    },<br/>    "max_size": 50,<br/>    "min_size": 0,<br/>    "name": "sast-engine-extra-large",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "sast-engine-extra-large",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "r6iz.4xlarge"<br/>    ],<br/>    "labels": {<br/>      "sast-engine-xxl": "true"<br/>    },<br/>    "max_size": 50,<br/>    "min_size": 0,<br/>    "name": "sast-engine-xxl",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "sast-engine-xxl",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "r6iz.4xlarge"<br/>    ],<br/>    "labels": {<br/>      "sast-engine-xxxl": "true"<br/>    },<br/>    "max_size": 50,<br/>    "min_size": 0,<br/>    "name": "sast-engine-xxxl",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "sast-engine-xxxl",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 1,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "kics-engine": "true"<br/>    },<br/>    "max_size": 20,<br/>    "min_size": 1,<br/>    "name": "kics-engine"<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "zeebe": "true"<br/>    },<br/>    "max_size": 5,<br/>    "min_size": 0,<br/>    "name": "zeebe",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "zeebe",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 1,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "repostore": "true"<br/>    },<br/>    "max_size": 10,<br/>    "min_size": 1,<br/>    "name": "repostore",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "repostore",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 0,<br/>    "instance_types": [<br/>      "m7i.2xlarge",<br/>      "m6a.2xlarge",<br/>      "m6i.2xlarge"<br/>    ],<br/>    "labels": {<br/>      "minio-gateway": "true"<br/>    },<br/>    "max_size": 10,<br/>    "min_size": 0,<br/>    "name": "minio-gateway",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "minio-gateway",<br/>        "value": "true"<br/>      }<br/>    }<br/>  },<br/>  {<br/>    "capacity_type": "ON_DEMAND",<br/>    "desired_size": 1,<br/>    "instance_types": [<br/>      "m7i.4xlarge",<br/>      "m6a.4xlarge",<br/>      "m6i.4xlarge"<br/>    ],<br/>    "labels": {<br/>      "service": "sca-source-resolver"<br/>    },<br/>    "max_size": 10,<br/>    "min_size": 1,<br/>    "name": "sca-source-resolver",<br/>    "taints": {<br/>      "dedicated": {<br/>        "effect": "NO_SCHEDULE",<br/>        "key": "service",<br/>        "value": "sca-source-resolver"<br/>      }<br/>    }<br/>  }<br/>]</pre> | no |
...
| <a name="input_kube_proxy_version"></a> [kube\_proxy\_version](#input\_kube\_proxy\_version) | The version of the EKS Kube Proxy Addon. Reference https://docs.aws.amazon.com/eks/latest/userguide/managing-kube-proxy.html#kube-proxy-versions. | `string` | `"v1.30.9-eksbuild.3"` | no |
...
| <a name="output_ec"></a> [ec](#output\_ec) | n/a |
